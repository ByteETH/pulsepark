...
export default function ThirdSection({ id }) {
  ...
  const generateMemberBoxes = () => {
    const members = [
      ...
      { id: 33, name: "Corey Costa", imageUrl: "/team/34.png", href: "https://twitter.com/coreycosta123" },
      { id: 34, name: "JustAskJesse", imageUrl: "/team/35.png", href: "https://twitter.com/JustAskJesse" },
      { id: 35, name: "WaLLrus", imageUrl: "/team/36.png", href: "https://twitter.com/WaLLrusOfficial" },
      { id: 36, name: "Hex Keef", imageUrl: "/team/37.png", href: "https://twitter.com/murdersauce" },
      { id: 37, name: "yourfriendSOMMI", imageUrl: "/team/38.png", href: "https://twitter.com/yourfriendSOMMI" },
      { id: 38, name: "NagaBeau", imageUrl: "/team/39.png", href: "https://twitter.com/BeauNaga" },
      { id: 39, name: "DJ Cryptomatic", imageUrl: "/team/40.png", href: "https://twitter.com/djcryptomatic" },
      { id: 40, name: "hodldog", imageUrl: "/team/41.png", href: "https://twitter.com/hodldogofficial" },
      { id: 41, name: "TAngent", imageUrl: "/team/42.png", href: "https://twitter.com/HEX_TAngent" },
      { id: 42, name: "bretep", imageUrl: "/team/43.png", href: "https://twitter.com/bretep" },
      { id: 43, name: "Lil Hexico", imageUrl: "/team/44.png", href: "https://twitter.com/lilhexico" },
      { id: 44, name: "Taylor B. Crypto", imageUrl: "/team/46.png", href: "https://twitter.com/PulseGains" },
      { id: 45, name: "Joe Parys", imageUrl: "/team/49.png", href: "https://twitter.com/JoeParys" },
      { id: 46, name: "Frossty", imageUrl: "/team/50.png", href: "https://twitter.com/hexadori5555" },
      { id: 47, name: "Captain RG3", imageUrl: "/team/51.png", href: "https://twitter.com/CaptainRG3" },
      { id: 48, name: "SammyChica", imageUrl: "/team/52.png", href: "https://twitter.com/sammyChica" },
      { id: 49, name: "TrevonJames", imageUrl: "/team/53.png", href: "https://twitter.com/TrVon" },
      { id: 50, name: "Croat", imageUrl: "/team/54.png", href: "https://twitter.com/Crobot01" },
      { id: 51, name: "Ian Heinisch", imageUrl: "/team/55.png", href: "https://twitter.com/ianheinischmma" },
      { id: 52, name: "AXiS ALiVE", imageUrl: "/team/56.png", href: "https://twitter.com/AxisAlive" },
      { id: 53, name: "MOON KING B-ROOTS ", imageUrl: "/team/57.png", href: "https://twitter.com/iambroots" },
      { id: 54, name: "LizG", imageUrl: "/team/58.png", href: "https://twitter.com/lizethgiraldo_" },
      { id: 55, name: "Hexologist", imageUrl: "/team/59.png", href: "https://twitter.com/Hexologist31" },
      { id: 56, name: "Ran Neuner", imageUrl: "/team/60.png", href: "https://twitter.com/cryptomanran" },
      { id: 57, name: "Christy Todd", imageUrl: "/team/61.png", href: "https://twitter.com/christytodd71" },
      { id: 58, name: "Wendy O", imageUrl: "/team/62.png", href: "https://twitter.com/CryptoWendyO" },
      { id: 59, name: "Ivan on Tech", imageUrl: "/team/63.png", href: "https://twitter.com/IvanOnTech" },
      { id: 60, name: "Ben Armstrong", imageUrl: "/team/65.png", href: "https://twitter.com/BenArmstrongsX" }
    ];
